...
const Inventory = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await fetch("https://alcohal-server.gofastapi.com/api/products");
      if (!response.ok) throw new Error(`Error: ${response.statusText}`);
      const data = await response.json();
  ...
  const updateQuantity = async (productId) => {
    ...
    try {
      const response = await fetch("https://alcohal-server.gofastapi.com/api/products/update", {
        method: "POST",
  ...
  const addProduct = async () => {
    ...
    try {
      const response = await fetch("https://alcohal-server.gofastapi.com/api/products/add", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
